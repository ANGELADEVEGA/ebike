...
export default function Home() {
  ...
  const scrollToPreviousText = () => {
    ...
    if (currentTextIndex > 0) {
      ...
      setCurrentSlide((prev) => (prev - 1 + slides.length) % slides.length);textItems[currentTextIndex - 1].classList.add('visible');
    }
  };
    ...
    <div>
      ...
      <main>
        <div className="snap-y snap-mandatory scroll-smooth h-screen">
              ...
              <div>
                <div className="flex flex-col content-center space-y-2">
                  ...
                  <div className="flex space-x-4 items-center">
                    ...
                    />
                    <img
                      src="https://i.ibb.co/vH9PbmN/google-photos.png"
                  ...
                  <div className="flex space-x-4 items-center">
                    <img
                      src="https://i.ibb.co/gMKRDfV/instagram.png"
                      alt="instagram-logo"
                      className="w-20 h-20"
                    />
                    <img
          ...
          <section className="snap-start h-screen flex justify-center items-center relative" style={{ background: bgGradient,position: 'relative', overflow: 'hidden'}}>
        ...
        <div className="mt-5">
          ...
          <div>
            <div className="flex" style={{ display: 'flex' }}>
             ...
             {/* Scrollbar container on the left */}
           <div className="scroll-bar-container" style={{ position: 'absolute', left: '0', top: '0', width: '20px', height: '50px', backgroundColor: 'transparent', zIndex: 0 }}>
              <div className="scroll-bar" style={{ width: '3px', height: '100%', backgroundColor: 'black', position: 'absolute', top: '0', left: '20px', zIndex: 1 }}></div>
              </div>
